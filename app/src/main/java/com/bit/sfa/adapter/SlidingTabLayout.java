...
//        mTf = Typeface.createFromAsset(context.getAssets(), "OpenSans-Regular.ttf");
       ...
       // textView.setTypeface(mTf);
        ...
        //textView.setBackground(R.drawable.menu_button_background);
        //textView.setBackground(ContextCompat.getDrawable(context, R.drawable.menu_button_background));
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabTitleView.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.button_default_bg));
            }
