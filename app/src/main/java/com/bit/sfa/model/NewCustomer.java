...
public class NewCustomer {
    ...
    public JSONObject getOutletAsJSON() throws JSONException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault());
        HashMap<String, Object> finalJSONParams = new HashMap<>();
        HashMap<String, Object> customerParams = new HashMap<>();
        customerParams.put("refno", CUSTOMER_ID);
        customerParams.put("customer", NAME);
        customerParams.put("route", ROUTE_ID);
        customerParams.put("latitude", C_LATITUDE);
        customerParams.put("longitude", C_LONGITUDE);
        customerParams.put("address", ADDRESS1);
        customerParams.put("mobile", MOBILE);
        customerParams.put("email", E_MAIL);
        customerParams.put("nextnumval", NUMVAL);


        JSONObject invoiceJSON = new JSONObject(customerParams);
        finalJSONParams.put("Outlet", invoiceJSON);
        JSONObject finalObject = new JSONObject(finalJSONParams);
        Log.wtf("New Customer CLASS ", "New Customer\n" + finalObject.toString());
