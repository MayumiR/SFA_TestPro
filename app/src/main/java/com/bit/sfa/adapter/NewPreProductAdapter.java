...
public class NewPreProductAdapter extends BaseAdapter {
    ...
    private ArrayList<tempOrderDet> preProductArrayList;
    Context context;
    private String preText = null;


    public NewPreProductAdapter(Context context, ArrayList<tempOrderDet> preProductArrayList) {
    ...
    @Override
    public tempOrderDet getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final tempOrderDet preProduct = getItem(position);
        ...
        viewHolder.btnMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (--qty >= 0) {
                    ...
                    new OrderTempController(context).updateProductQty(preProduct.getPREPRODUCT_ITEMCODE(), viewHolder.lblQty.getText().toString());
                }
                ...
                CustomKeypadDialog keypad = new CustomKeypadDialog(context, false, new CustomKeypadDialog.IOnOkClickListener() {
                    ...
                    public void okClicked(double value) {
                       ...
                       // Log.d("<>+++++", "" + distrStock);
                        ...
                        new OrderTempController(context).updateProductQty(preProduct.getPREPRODUCT_ITEMCODE(), String.valueOf(enteredQty));
